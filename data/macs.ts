...
export const macProducts: MacProduct[] = [
  // MacBook Air M2
  {
    ...
    weight: 1.24,
    batteryLife: 18,
    image: '/images/macs/macbook-air.svg',
    affiliateLinks: {
  ...
  // MacBook Pro M3 14"
  {
    ...
    weight: 1.55,
    batteryLife: 22,
    image: '/images/macs/macbook-pro.svg',
    affiliateLinks: {
  ...
  // Mac mini M2
  {
    ...
    releaseYear: 2023,
    image: '/images/macs/mac-mini.svg',
    affiliateLinks: {
  ...
  // Mac Studio M2 Max
  {
    ...
    bestFor: ['professional', 'creative', 'video-editing', '3d-rendering'],
    releaseYear: 2023,
    image: '/images/macs/mac-studio.svg',
    affiliateLinks: {
